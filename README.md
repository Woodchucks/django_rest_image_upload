...
# Assumptions
- The time in seconds provided by the user for Expiring links, for plan 'Enterprise' are to be counted from the time the original image was uploaded
...
- For performance considerations images should not be saved in the database as such, just figure as serialized representation of themselves kept in the database
